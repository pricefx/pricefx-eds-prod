...
`;
  ...
  filter.innerHTML = `
    ...
    ${filterOne !== '' ? renderFilterCategory(1, filterOne, false, filterOneOptions, 'filter-all-content-type', 'filter-type') : ''}
    ${filterTwo !== '' ? renderFilterCategory(2, filterTwo, false, filterTwoOptions, 'filter-all-industry', 'filter-industry') : ''}
    ${filterThree !== '' ? renderFilterCategory(3, filterThree, false, filterThreeOptions, 'filter-all-role', 'filter-role') : ''}

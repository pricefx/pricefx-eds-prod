      ...
      items: [
        {
          ...
          eventDescription: {
            plaintext:
              'Pricefx is a proud sponsor of the Professional Pricing Society’s annual spring conference this year',
          },
        ...
        },
        {
          ...
          eventDescription: {
            plaintext:
              'Imaginez un seul instant que votre entreprise gère encore ses RH, paie, logistique, données clients',
          },
...
`;
  ...
  const renderFilterCategory = (
    ...
    optionsArray.forEach((option, index) => {
      const checkValue = index === 0 ? 'checked' : '';
      ...
      filterOptionsMarkup += `
          <li class="filter-category-item">
            <input type="radio" id="filter-${optionSplit}" ${checkValue} name="${filterCategoryName}" value="${optionSplit}" data-filter-category="${filterCategoryName}" />
